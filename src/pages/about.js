        ...
        <Layout>
            <div className="flex">
                <div className="text-center px-4 mb-6">
                    <p className="mt-6 text-sm md:text-base text-justify text-gray-600">
                    ...
                    <h2 className="text-opacity-100 mt-10 text-md md:text-lg text-justify font-bold text-green-600">
                    ...
                    <p className="mt-1 text-sm md:text-base text-justify text-gray-600">
