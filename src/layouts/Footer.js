...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="lg:hidden flex flex-wrap w-full fixed bottom-0 right-0 left-0 h-12 p-2 bg-gray-100 border-1 border-gray-300 items-center justify-center">
